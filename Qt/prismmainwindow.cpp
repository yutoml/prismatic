...
bool validateWriteFilename(const std::string str)
{
    ...
    std::ofstream f(str);
    if (f.good())
        std::cout << "file " << str << " good" << std::endl;
    return f.good();
}
...
PRISMMainWindow::PRISMMainWindow(QWidget *parent) : QMainWindow(parent),
                                                    ...
                                                    colormapper(Prismatic::Colormapper(Prismatic::VioletFireColormap))
{
    ...
    connect(this->ui->lineEdit_maxFileSize, SIGNAL(editingFinished()), this, SLOT(setmaxFileSize_fromLineEdit()));
...
void PRISMMainWindow::openSaveAtomsDialog()
{
    ...
    std::stringstream tileX_ss;
    tileX_ss << meta->tileX;
    std::stringstream tileY_ss;
    tileY_ss << meta->tileY;
    std::stringstream tileZ_ss;
    tileZ_ss << meta->tileZ;
        ...
        if (ui->checkBox_sqrtIntensityPot->isChecked())
        {
            for (auto j = 0; j < potential.get_dimj(); ++j)
            {
                for (auto i = 0; i < potential.get_dimi(); ++i)
                {
                    ...
                    potentialImage.setPixel(j, i, this->colormapper.getColor(std::sqrt(potentialImage_float.at(j, i)), contrast_potentialMin, contrast_potentialMax));
                }
            }
        }
        else
        {
            for (auto j = 0; j < potential.get_dimj(); ++j)
            {
                for (auto i = 0; i < potential.get_dimi(); ++i)
                {
                    ...
                    //                                                      contrast_potentialMax);
                    //                        potentialImage.setPixel(j, i, qRgba(val,val,val,255));
                    potentialImage.setPixel(j, i, this->colormapper.getColor(potentialImage_float.at(j, i), contrast_potentialMin, contrast_potentialMax));
                }
            }
        }
    ...
    if (checkProbesCalculated())
    {
        ...
        if (ui->checkBox_log->isChecked())
        {
            ...
            for (auto j = 0; j < probeImage_pk_float.get_dimj(); ++j)
            {
                ...
                {
                    probeImage_pk.setPixel(j, i, this->colormapper.getColor(std::log(1e-5 + std::abs(probeImage_pk_float.at(j, i))), cLow, cHigh));
                }
            }
        }
        else
        {
            for (auto j = 0; j < probeImage_pk_float.get_dimj(); ++j)
            {
                for (auto i = 0; i < probeImage_pk_float.get_dimi(); ++i)
                {
                    probeImage_pk.setPixel(j, i, this->colormapper.getColor(probeImage_pk_float.at(j, i), cLow, cHigh));
                }
            }
        }
    ...
    if (checkProbesCalculated())
    {
        ...
        if (ui->checkBox_log->isChecked())
        {
            ...
            for (auto j = 0; j < probeImage_pr_float.get_dimj(); ++j)
            {
                ...
                {
                    probeImage_pr.setPixel(j, i, this->colormapper.getColor(std::log(1e-5 + std::abs(probeImage_pr_float.at(j, i))), cLow, cHigh));
                }
            }
        }
        else
        {
            for (auto j = 0; j < probeImage_pr_float.get_dimj(); ++j)
            {
                for (auto i = 0; i < probeImage_pr_float.get_dimi(); ++i)
                {
                    probeImage_pr.setPixel(j, i, this->colormapper.getColor(probeImage_pr_float.at(j, i), cLow, cHigh));
                }
            }
        }
    ...
    if (checkProbesCalculated())
    {
        ...
        if (ui->checkBox_log->isChecked())
        {
            ...
            for (auto j = 0; j < probeImage_mk_float.get_dimj(); ++j)
            {
                ...
                {
                    probeImage_mk.setPixel(j, i, this->colormapper.getColor(std::log(1e-5 + std::abs(probeImage_mk_float.at(j, i))), cLow, cHigh));
                }
            }
        }
        else
        {
            for (auto j = 0; j < probeImage_mk_float.get_dimj(); ++j)
            {
                for (auto i = 0; i < probeImage_mk_float.get_dimi(); ++i)
                {
                    probeImage_mk.setPixel(j, i, this->colormapper.getColor(probeImage_mk_float.at(j, i), cLow, cHigh));
                }
            }
        }
    ...
    if (checkProbesCalculated())
    {
        ...
        if (ui->checkBox_log->isChecked())
        {
            ...
            for (auto j = 0; j < probeImage_mr_float.get_dimj(); ++j)
            {
                ...
                {
                    probeImage_mr.setPixel(j, i, this->colormapper.getColor(std::log(1e-5 + std::abs(probeImage_mr_float.at(j, i))), cLow, cHigh));
                }
            }
        }
        else
        {
            for (auto j = 0; j < probeImage_mr_float.get_dimj(); ++j)
            {
                for (auto i = 0; i < probeImage_mr_float.get_dimi(); ++i)
                {
                    probeImage_mr.setPixel(j, i, this->colormapper.getColor(probeImage_mr_float.at(j, i), cLow, cHigh));
                }
            }
        }
    ...
    if (checkProbesCalculated())
    {
        ...
        if (ui->checkBox_log->isChecked())
        {
            ...
            for (auto j = 0; j < probeImage_diffr_float.get_dimj(); ++j)
            {
                ...
                {
                    probeImage_diffr.setPixel(j, i, this->colormapper.getColor(std::log(1e-5 + std::abs(probeImage_diffr_float.at(j, i))), cLow, cHigh));
                }
            }
        }
        else
        {
            for (auto j = 0; j < probeImage_diffr_float.get_dimj(); ++j)
            {
                for (auto i = 0; i < probeImage_diffr_float.get_dimi(); ++i)
                {
                    probeImage_diffr.setPixel(j, i, this->colormapper.getColor(probeImage_diffr_float.at(j, i), cLow, cHigh));
                }
            }
        }
    ...
    if (checkProbesCalculated())
    {
        ...
        if (ui->checkBox_log->isChecked())
        {
            ...
            for (auto j = 0; j < probeImage_diffk_float.get_dimj(); ++j)
            {
                ...
                {
                    probeImage_diffk.setPixel(j, i, this->colormapper.getColor(std::log(1e-5 + std::abs(probeImage_diffk_float.at(j, i))), cLow, cHigh));
                }
            }
        }
        else
        {
            for (auto j = 0; j < probeImage_diffk_float.get_dimj(); ++j)
            {
                for (auto i = 0; i < probeImage_diffk_float.get_dimi(); ++i)
                {
                    probeImage_diffk.setPixel(j, i, this->colormapper.getColor(probeImage_diffk_float.at(j, i), cLow, cHigh));
                }
            }
        }
    ...
    if (checkoutputArrayExists())
    {
        ...
        for (auto j = 0; j < output.get_dimk(); ++j)
        {
            for (auto i = 0; i < output.get_dimj(); ++i)
            {
                ...
                outputImage.setPixel(j, i, this->colormapper.getColor(outputImage_float.at(j, i), contrast_outputMin, contrast_outputMax));
            }
        }
...
void PRISMMainWindow::updateOutputDisplay_HRTEM()
{
    if (checkoutputArrayExists_HRTEM())
    {
        ...
        for (auto j = 0; j < smatrix.get_dimj(); ++j)
        {
            for (auto i = 0; i < smatrix.get_dimi(); ++i)
            {
                outputImage_HRTEM.setPixel(j, i, this->colormapper.getColor(outputImage_HRTEM_float.at(j, i), contrast_outputMin_HRTEM, contrast_outputMax_HRTEM));
            }
        }
...
void PRISMMainWindow::saveCurrentOutputImage()
{
    if (checkoutputArrayExists())
    {
        ...
        for (auto i = 0; i < outputImage_float.size(); i++)
            tmp_buffer[i] = std::floor(255 * (outputImage_float[i] - min_val) / (max_val - min_val));
